...
public class MTAUtils {
    ...
    private static String SID = "500735096";
    ...
    public static void click(String actionsId) {
        cachedThreadPool.execute(new ClickTask(actionsId));
    }
    ...
    private static class ClickTask implements Runnable {
        ...
        public ClickTask(String actionsId) {
